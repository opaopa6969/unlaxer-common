 ...
 * @since  1.8
*/
public final class SourceJoiner {
     ...
     */
    public SourceJoiner(CharSequence delimiter) {
        this(delimiter, "", "");
    }
     ...
     *         {@code null}
     */
    public SourceJoiner setEmptyValue(CharSequence emptyValue) {
     ...
     */
    public SourceJoiner add(CharSequence newElement) {
     ...
     */
    public SourceJoiner merge(SourceJoiner other) {
